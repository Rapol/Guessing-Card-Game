...
public class EasyLevel extends GameLevel {
	...
	protected EasyLevel(TurnsTakenCounterLabel validTurnTime,/*Score scoreValid*/ JFrame mainFrame) {
		super(validTurnTime, /*scoreValid,*/ 2, mainFrame);
		this.turnsTakenCounter.setDifficultyModeLabel("Easy Mode");
//		this.scoreCounter.setDifficultyModeLabel("Easy Mode");
		this.cardsPerRow = 4;
		this.rowsPerGrid = 4;
