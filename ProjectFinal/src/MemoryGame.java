...
public class MemoryGame implements ActionListener {
		...
		try {
			...
			else if(e.getActionCommand().equals("Equal Pair Level")) 
			{
				int n = JOptionPane.showConfirmDialog(
						this.mainFrame,
						"Any current score gained will be deleted. Do you wish to continue?",
						"Memory Game",
			...
			else if(e.getActionCommand().equals("Full House Level"))
			{
				int n = JOptionPane.showConfirmDialog(
						this.mainFrame,
						"Any current score gained will be deleted. Do you wish to continue?",
			...
			else if(e.getActionCommand().equals("Straight Flush Level"))
			{
				int n = JOptionPane.showConfirmDialog(
						this.mainFrame,
						"Any current score gained will be deleted. Do you wish to continue?",
	...
	public void newGame(String difficultyMode) throws IOException
	{
		...
		//		this.scoreCounterLabel=new Score();
		...
		else if(difficultyMode.equalsIgnoreCase("house")){
			this.difficulty=new FullHouseLevel(this.turnCounterLabel,this.mainFrame);
		}
		else if(difficultyMode.equalsIgnoreCase("straight")){
			this.difficulty=new StraightFlushLevel(this.turnCounterLabel,this.mainFrame);
		}
